...
//     useEffect(() => {
//         axios.get(apiurluser + "fetch?email=" + localStorage.getItem("email")).then((res) => {
...
//     const handleSubmit = () => {
//         axios.patch(apiurluser + "update?email=" + email, { name, mobile, address, city, gender }).then((res) => {
...
//                                     <button type="button" class="epadmin-btn" onClick={handleSubmit}>Update Profile</button>
//                                 </form>
//                             </div>
//                         </div>
//                     </div>
...
function EpStudent() { 
  ...
  const [preview, setPreview] = useState("https://dummyimage.com/120x120/cccccc/000000&text=Student");
